...
# 5b. Copier le logo Solana
if [ -f "Facio/Resources/solanaLogo.png" ]; then
    cp "Facio/Resources/solanaLogo.png" "$APP_DIR/Contents/Resources/solanaLogo.png"
    echo "    Logo Solana copie."
fi
