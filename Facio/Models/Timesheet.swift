...
final class TimesheetPeriod: Identifiable, Codable, Hashable {
    ...
    required init(from decoder: Decoder) throws {
        ...
        semaines = try c.decodeOrDefault([TimesheetWeek].self, forKey: .semaines, default: [])
        createdAt = try c.decodeOrDefault(Date.self, forKey: .createdAt, default: Date())
        invoiceDocumentId = try? c.decode(UUID.self, forKey: .invoiceDocumentId)
        billedAt = try? c.decode(Date.self, forKey: .billedAt)
        invoiceDetailModeRawValue = try c.decodeOrDefault(
            String.self,
        ...
        clientNom = try c.decodeOrDefault(String.self, forKey: .clientNom, default: "")
        clientAdresse = try c.decodeOrDefault(String.self, forKey: .clientAdresse, default: "")
        clientCodePostal = try c.decodeOrDefault(String.self, forKey: .clientCodePostal, default: "")
        clientVille = try c.decodeOrDefault(String.self, forKey: .clientVille, default: "")
        clientSiret = try c.decodeOrDefault(String.self, forKey: .clientSiret, default: "")
        clientTva = try c.decodeOrDefault(String.self, forKey: .clientTva, default: "")
        clientApe = try c.decodeOrDefault(String.self, forKey: .clientApe, default: "")
        timeEntries = try c.decodeOrDefault([TimeEntry].self, forKey: .timeEntries, default: [])
        updatedAt = try c.decodeOrDefault(Date.self, forKey: .updatedAt, default: createdAt)
        tauxNormal = try c.decodeOrDefault(Decimal.self, forKey: .tauxNormal, default: 26.39)
